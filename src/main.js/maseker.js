...
function bootChat(e) {
    ...
    if (text.value == '') {
        ...
        <div class="mass_container">
            <div class="user_img"><img src="./images/icons/user.png" alt=""></div>
            <p class="massge">${smartText}</p>
        </div>
        `
        );
        massgae.insertAdjacentHTML('beforeend',
        ...
        if (smartText == 'yes' || smartText == 'Yes') {
                    ...
                    if (inp_mass_email.value.indexOf('@') == -1 || inp_mass_email.value.indexOf('.') == -1 || inp_mass_email.value.length < 10) {
                        ...
                        setTimeout(() => {
                            ...
                            massgae.insertAdjacentHTML('beforeend',
                                `
                                <div class="mass_container">
                                    <p class = "massge" id="end">
                                        Thank You We Will Contact With You Soon GoodBye
            ...
            setTimeout(() => {
                ...
                massgae.insertAdjacentHTML('beforeend',
                    ...
                    <div class="mass_container">
                        <p class = "massge">
                            It was a pleasure doing business with you, best regards 
                        </p>
                        <div class="user_img">
                            <img src="./images/icons/bot.png" alt="">
                        </div>
            ...
            setTimeout(() => {
                ...
                <div class="mass_container">
                    <p class="massge">
                        We Will Contact With You As Soon As Possible We Will Send You From Now To Apply Your
                        Data To Contact With You If You Want That Please Send Yes Or No If You Dont
                    </p>
                    <div class="user_img">
                        <img src="./images/icons/bot.png" alt="">
                    </div>
